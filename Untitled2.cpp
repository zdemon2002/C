...
item1-=K;
cout<<"Customer "<<id<<" has successfully purchased quantity "<<K<<" of Item no 1"<<endl<<endl;
}
q.pop();
}
else if(item_no==2)
...
item2-=K;
cout<<"Customer "<<id<<" has successfully purchased quantity "<<K<<" of Item no 2"<<endl<<endl;
}
q.pop();
}
else
...
item3-=K;
cout<<"Customer "<<id<<" has successfully purchased quantity "<<K<<" of Item no 3"<<endl<<endl;
}
q.pop();
}
}   
